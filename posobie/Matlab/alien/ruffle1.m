...
re_ordering=[];  % re_ordering will be the 
                 % face-value ordering after the ruffle
slot=1;
last=1;
position_perm=[];   % position_perm will be the position permutation after the ruffle
